  ...
  module V1
    class AuthenticationController < ApiController
      ...
      def reset_password
        ...
        raise BadRequestError.new("Invalid reset password token") unless user.present?
        raise BadRequestError.new("Invalid password") if params[:new_password].present? && params[:new_password_confirmation] == params[:new_password]
      ...
      def change_password
        ...
        raise BadRequestError.new("Invalid old password") if !current_user.valid_password?(params[:old_password])
